    ...
    return (
        <>
            <div className="flex justify-center items-center h-screen bg-gradient-to-r from-purple-500 to-green-500 font-bold">
                <div className="rounded-2xl backdrop-blur-xl bg-white/20 dark:bg-black/20 p-5 shadow-lg mx-5">
                    <h1 className="text-end text-2xl">
                        آموزش رانندگی خصوصی در قزوین
                    </h1>
                    <hr className="my-5"/>
                    ...
                    <div className="mt-10 text-end bg-gray-400 dark:bg-gray-600 rounded-xl p-2">
                        <p>
                        ...
                        <div className="text-center flex justify-between items-center mt-5">
                            <div className="flex justify-between items-start space-x-2">
                                <a href="tel:+989127833195" className="p-2 rounded-full bg-gray-300 dark:bg-gray-700 hover:shadow-lg">
                                ...
                                <a href="tel:+989127833195" className="py-2 px-3 rounded-full bg-gray-300 dark:bg-gray-700 hover:shadow-lg">
                                    ۰۹۱۲۷۸۳۳۲۹۵
                                </a> 
                            </div>
